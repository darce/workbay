...
This document hosts the generated portable command router block used by Codex
and related workflow consumers. The marked section is generator-owned.
...
For task-specific procedures, defer to the package and plan documents in this
repository.