...
- [task-start receipt / spool_drain](../../packages/workbay-system/workbay_system/payload/docs/workbay/contracts/task-start-receipt.md) — success-path `spool_drain` keys and human pending-line grammar

## Lifecycle stages

| Stage | Skill / command | Outcome |
| --- | --- | --- |
| Scope | `/wb-scope` | Requirements clarified before planning |
