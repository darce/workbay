...
| Background work | Crons, webhooks, watches | Task-driven lanes, `/wb-offload`, review runs |
...
WorkBay lanes (`/wb-offload`, orchestrator worktrees, `/wb-review-slice`)
...
`workbay embeddings` / `/wb-harness`. Pair a memory plugin when you need
