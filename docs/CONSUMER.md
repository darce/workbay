...
| Server                   | Command line                                                |
| ------------------------ | ----------------------------------------------------------- |
| `workbay-handoff-mcp`      | `uvx mcp-workbay-handoff@0.1.0 --workspace-root . serve-stdio`      |
| `workbay-orchestrator-mcp` | `uvx mcp-workbay-orchestrator[bridge]@0.1.0 --workspace-root . serve-stdio` |
