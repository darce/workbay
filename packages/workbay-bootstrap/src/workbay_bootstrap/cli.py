    ...
    if args.command == "install":
        ...
        try:
            manifest = install(
                ...
                install_codex_ensure_agent_surfaces_hook=args.install_codex_ensure_agent_surfaces_hook,
                install_vscode_ensure_agent_surfaces_hook=args.install_vscode_ensure_agent_surfaces_hook,
    ...
    if args.command == "doctor":
        try:
            if args.only_telemetry:
                ...
                findings = doctor_telemetry(args.target)
            else:
                findings = doctor(
                    target=args.target,
