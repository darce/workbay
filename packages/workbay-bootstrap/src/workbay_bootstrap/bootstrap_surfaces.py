...
Tracked-vs-overlay ownership boundaries are declared in
:mod:`workbay_bootstrap.overlay_boundary`.
"""
...
def _git_head_sha(target: Path) -> str:
    ...
    try:
        # Preserve the prior direct-subprocess 30s bound via timeout_override;
        # call_class=git default is 120s (DEFAULT_TIMEOUTS).
        return run_external(
