...
SURFACE_PROVENANCE: dict[str, SurfaceKind] = {
    ...
    "scripts/remote_agent.sh": "shared",
    "scripts/review_pipeline.py": "shared",
    "scripts/assert_gate_interpreter.sh": "shared",
    ...
    # lifecycle — LIFECYCLE_HOISTS destinations (internal).
    # Provenance stays legible for every hoist dest. The fence derives from
    # this kind but omits children already covered by shared parents
    # (Makefile.d, scripts/workbay); scripts/workbay_lifecycle is the sole
    # top-level sibling that needs its own fence line (Defect 1A).
    "Makefile.d/lifecycle.mk": "lifecycle",
    "scripts/workbay_lifecycle": "lifecycle",
    "Makefile.d/update.mk": "lifecycle",
    "scripts/workbay/update.sh": "lifecycle",
}
