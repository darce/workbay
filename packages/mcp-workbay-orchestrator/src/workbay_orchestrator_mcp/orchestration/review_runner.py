...
def _record_findings(
    ...
    *,
    ...
    if persist_receipt_ok(batch_result, recorded_ids):
        return _persist_result(recorded_ids)
    ...
    for item in batch_items:
        ...
        if persist_receipt_ok(item_result, [finding_id]):
            ...
            fallback_failures[finding_id] = receipt_cause(item_result, [finding_id])

    unrecorded_ids = [finding_id for finding_id in recorded_ids if finding_id not in recorded_after_failure]
