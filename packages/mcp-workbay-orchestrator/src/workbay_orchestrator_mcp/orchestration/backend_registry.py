...
BACKENDS: dict[str, BackendSpec] = {
    ...
    "cursor-remote": BackendSpec(
        ...
        # Curated authorization set MOVED here from the RemoteExecAdapter
        # backend-id name branch (implementation note finding 18210): the registry row
        # owns both the pin and the allow-list. Still hand-curated
        # (SECD-05) — never catalogue- or probe-derived.
