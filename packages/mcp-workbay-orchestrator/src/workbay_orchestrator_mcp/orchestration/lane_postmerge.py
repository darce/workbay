    ...
    *,
    ...
    if failed:
        ...
        return _cross_session_item(
            ...
            verdict="keep:probe_failed",
            preservation=preservation
            if preservation in _PRESERVED_KINDS or preservation == "unintegrated"
            else "unintegrated",
            ownership=ownership,
            cleanliness=cleanliness,
...
def _cross_session_close_notes(
    ...
    """
    return f"post-merge reap of {lane_id} at {tip_sha}; preserved-by {preserving_ref} sha {preserving_sha}"
