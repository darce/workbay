...
# Canonical home is this stdlib-only leaf so adapters and offload_profiles share
# one source of truth without import cycles. offload_profiles re-exports them.
