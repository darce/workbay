...
#
# Split from DEFAULT_GROK_MODEL so the shipped pin stays observable even when an
# operator override is active. Asserting on the env-resolved value alone means
# the test silently measures the operator's environment instead of this repo.
SHIPPED_GROK_MODEL = "grok-4.6"
...
_env = os.environ.get("WORKBAY_GROK_MODEL", "").strip()
DEFAULT_GROK_MODEL = _env or SHIPPED_GROK_MODEL
