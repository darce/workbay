...
from .offload_timeout_ssot import (  # noqa: F401
    OPENROUTER_REMOTE_LANE_TIMEOUT_S,
...
# OPENROUTER_REMOTE_LANE_TIMEOUT_S and OPENROUTER_TIMEOUT_CAP are re-exported
# from offload_timeout_ssot so every reader resolves the same objects (GRPH-03).
