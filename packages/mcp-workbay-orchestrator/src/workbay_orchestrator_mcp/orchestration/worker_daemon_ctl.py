...
def _remote_capability_identity(
    *,
    ...
    if row is not None:
        ...
        # policy via the same token builder as offload_preflight / RemoteExecAdapter
        # (HIFIX03F1RV-001): auto hashes as auto, inherit hashes the model
        # default, explicit efforts stay explicit.
        argv_effort = (
            requested_effort
        ...
        spec_effort = remote_exec._capability_digest_effort_token(requested_effort, argv_effort)
