...
from lane_test_cmd import LANE_ROW_TEST_CMD_READ_FAILED, lane_row_test_cmd_read_failure
...
def run_lane_exec(
    *,
    ...
    # Priority: Manifest pin > starting backend (implementation note S3 alignment,
    # GK-0145-02): the materialized pin is authoritative from any starting
    # backend, matching review_runner — one selection semantics, not two.
