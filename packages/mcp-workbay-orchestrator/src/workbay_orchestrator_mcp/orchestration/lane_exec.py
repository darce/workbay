...
from lane_routing import RoutingQuad, resolve_routing_quad
...
class LaneExecError(RuntimeError):
    ...
    def __init__(self, message: str, *, jailed: bool) -> None:
...
def run_lane_exec(
    *,
    ...
    try:
        ...
        raise LaneExecError(str(exc), jailed=jailed) from exc
