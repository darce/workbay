...
# Profile-independent CLI vocabulary. ``max`` is admitted by OpenRouter's
# model-specific profile; standard profiles retain the narrower set below.
STANDARD_WORKER_REASONING_EFFORT_CHOICES = ("inherit", "auto", *CODEX_REASONING_EFFORTS)
WORKER_REASONING_EFFORT_CHOICES = (*STANDARD_WORKER_REASONING_EFFORT_CHOICES, "max")
