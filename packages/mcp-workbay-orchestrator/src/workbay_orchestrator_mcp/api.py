        ...
        if start_worker:
            ...
            if isinstance(worker_start_result, dict) and worker_start_result.get("ok") is False:
                ...
                if warnings:
                    ...
                    response["warning"] = GROK_BRIEF_SUBAGENT_STEPS_WARNING
...
def run_offload_pass(
    ...
    checkpoint`) with token telemetry, checkpoint refs, and always-present
