...
```bash
REF=v0.1.54  # a released tag from https://github.com/darce/workbay/tags
...
```json
{
  ...
  "args": [
    "--no-sources",
    "--with",
    "git+https://github.com/darce/workbay.git@v0.1.54#subdirectory=packages/workbay-protocol",
    "--from",
    "git+https://github.com/darce/workbay.git@v0.1.54#subdirectory=packages/mcp-workbay-handoff",
    "mcp-workbay-handoff",
    "--workspace-root",
    "/path/to/workspace",
    "serve-stdio"
