...
```json
{
  ...
  "args": [
    "--no-sources",
    "--with",
    "git+https://github.com/darce/workbay.git@v0.1.35#subdirectory=packages/workbay-protocol",
    "--from",
    "git+https://github.com/darce/workbay.git@v0.1.35#subdirectory=packages/mcp-workbay-handoff",
    "mcp-workbay-handoff",
    "--workspace-root",
    "/path/to/workspace",
    "serve-stdio"
