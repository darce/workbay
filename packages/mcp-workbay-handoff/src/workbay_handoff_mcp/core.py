...
def close_slice(
    ...
    # Insert and DO UPDATE both change stored rationale and must re-embed;
    # DO NOTHING (operation='noop') must not. Match siblings [AGT-10]
    # (PLAN0181-S2EMBEDDRIFT-01).
    if mutation.get("operation") in {"insert", "update"}:
