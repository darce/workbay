...
def _serialize_semantic_detail_json(semantic_detail: Mapping[str, object]) -> str:
...
def _build_semantic_reinjection_for_refresh(
    ...
    *,
    ...
    try:
        from .embeddings.reinjection import ReinjectionConfig, build_semantic_reinjection_packet
    ...
    except Exception:  # noqa: BLE001 - fail-open on pull path
        return {
            "status": "degraded",
            "skip_reason": "error",
