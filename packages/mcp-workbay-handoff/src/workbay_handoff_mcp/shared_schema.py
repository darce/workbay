...
#         readers keep serving (MIN_COMPATIBLE_READER_VERSION stays 32). The
...
# Schema 33→34 adds a non-unique index only; 34→35 adds the additive
# ``review_findings_archive`` cold table. Both are additive, so the floor
# stays 32.
