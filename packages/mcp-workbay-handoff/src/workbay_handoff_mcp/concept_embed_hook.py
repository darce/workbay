...
def embed_concept_on_write(entity_kind: str, entity_id: object, task_ref: str, text: str | None) -> ConceptEmbedOutcome:
...
def embed_compaction_anchor_on_write(compaction_id: object, task_ref: str, text: str | None) -> AnchorStoreOutcome:
