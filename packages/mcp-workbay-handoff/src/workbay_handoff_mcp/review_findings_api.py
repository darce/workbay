...
from .shared_primitives import MAX_RESOLUTION_NOTES_LENGTH, _envelope
from .structured_rejections import rejection_resolution_notes_max_length
...
class ReviewFindingsResolveOp(BaseModel):
    ...
    notes: Annotated[
        ...
        Field(
            description=(
                f"Alias for resolution_notes (status-decision rationale). "
                f"Max {MAX_RESOLUTION_NOTES_LENGTH} characters."
            ),
            max_length=MAX_RESOLUTION_NOTES_LENGTH,
        ),
    ] = None
    verification_evidence: Annotated[
        ...
        Field(
            description=(
                "Optional verification evidence applied to each fixed finding in the resolve batch. "
                "Also accepted as rationale for deferred/wontfix status decisions."
            ),
        ),
    ] = None
    actor: ActorParam = None
