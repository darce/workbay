...
def _resolve_server_api_files(package_root: Path) -> dict[str, Path]:
    candidates_by_server: dict[str, tuple[Path, ...]] = {
        "workbay-handoff-mcp": (
            package_root.parent / "mcp-workbay-handoff" / "src" / "workbay_handoff_mcp" / "api.py",
            package_root / "packages" / "workbay-handoff-mcp" / "src" / "workbay_handoff_mcp" / "api.py",
        ),
        "workbay-orchestrator-mcp": (
            package_root.parent / "mcp-workbay-orchestrator" / "src" / "workbay_orchestrator_mcp" / "api.py",
            package_root / "packages" / "workbay-orchestrator-mcp" / "src" / "workbay_orchestrator_mcp" / "api.py",
        ),
    }
