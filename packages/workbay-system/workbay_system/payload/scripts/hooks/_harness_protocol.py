...
def handle_missing_contract(
    ...
    *,
    ...
    # A present-but-stale/malformed contract (HarnessContractSchemaError) is
    # untrustworthy: escalate to a hard exit 2 regardless of policy so a stale
    # contract cannot silently bypass main-branch isolation under WARN/SILENT
    # (finding PMR1-B82S1-stale-contract-warn-bypass). A merely-missing/unreadable
    # file is raised with schema=False and still honours the caller's policy below.
