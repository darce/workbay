...
| --- | --- | --- | --- | --- | --- |
| IDNT-01 | identity lives only in a corner logo | **Total identity** — design the full application surface so the brand survives crop and obscuring | If the logo corner is covered, is the piece still ours? | B·i | paula-scher-design ch-5 |
...
| IDNT-03 | mark approved off one hero surface | **Multi-platform premise** — extend to extreme scale, motion, environment, and language before approval | Does it still read at favicon size and on a facade? | B·i | design-indaba-dialogues ch-7 |
...
| IDNT-05 | logo brief is "freshen it" with associations intact | **Meaningful change only** — no redraw without a strategic why | What breaks if we leave the mark alone? | B·i | design-indaba-dialogues ch-6 |
...
| IDNT-10 | one typographic voice on the cover, another inside | **Form–content harmony** — one axial/typographic system end-to-end | Does every part share one system? | S·i | asymmetric-typography ch-4 |
...
| TYPE-08 | numerals in prose vs tables | **Numeral duty split** — old-style in running text, tabular-lining in tables (↔ eng dataviz rules for chart digits) | Do figures shout louder than words? | S·t | web-typography ch-10 |
| TYPE-09 | webfont blocks first paint | **FOUT-friendly body** — font-display fallback + metric-compatible fallbacks; readable before the font arrives | Is text readable pre-webfont? | B·t | web-typography ch-15 |
...
| ID | Trigger | Rule | Answers | T·P | Src |
| --- | --- | --- | --- | --- | --- |
| COL-01 | palette picked from a generator before the brief | **Concept-first palette** — scheme structure and colour roles before any hex | Can I state the concept without naming colours? | S·c | colour-theory-cianci ch-14 |
...
| COL-03 | multi-colour set at equal chroma | **Harmony roles** — dominant / support / accent / neutral; one anchor (↔ eng UI-07 stores the shades) | Which one colour is the identity anchor? | S·c | colour-theory-cianci ch-5 |
...
| COL-07 | brand deck cites colour-psychology tests | **No pseudo colour-psychology** — culture and perception claims only, testable in market | Is the claim testable? | S·b | colour-theory-cianci ch-10 |
...
| COL-10 | imagery pipeline untested across skin tones | **Inclusive grade test** — preserve detail and dignity across skin; doubly binding for an accessibility product | Whose skin was the pipeline built for? | B·im | colour-theory-cianci ch-15 |
...
| ID | Trigger | Rule | Answers | T·P | Src |
| --- | --- | --- | --- | --- | --- |
| LAY-01 | all blocks carry equal visual weight | **Contrast engine / big-little law** — hierarchy via size, weight, position, silhouette; one dominant | What must dominate, and what is subdued? | S·l | asymmetric-typography ch-5 |
...
| LAY-04 | more than three competing units at a glance | **Three-group rule** — regroup into sense units absorbable without counting | Can the structure be grasped without counting? | S·l | asymmetric-typography ch-8 |
...
| LAY-06 | hierarchy depends on boxes and rules | **Hierarchy without ornament** — weight/size/position carry meaning; frames are a crutch | If ornament vanished, would hierarchy remain? | S·l | asymmetric-typography ch-2 |
| LAY-07 | brief could take classical symmetry or modern asymmetry | **Two-system choice** — symmetry when content/tradition honestly demand dignity; asymmetry for differentiated information | Which system does the content require? | J·l | asymmetric-typography ch-4 |
...
| BRND-02 | campaigns milk founding heritage for growth optics | **No family-silver melt** — founding belief is capital; seasonal extraction spends it | Are we spending belief or building it? | B·b | design-indaba-dialogues ch-3 |
| BRND-03 | cannot state what the org feels like in one sentence | **Emotional core first** — distil before form; the sentence the client will defend | One sentence we'd defend under attack? | S·b | design-indaba-dialogues ch-7 |
| BRND-04 | attribute list contains contradictory poles | **No blanding brief** — refuse exclusive+inclusive personality mashes; singular briefs make memorable design | Is the brief singular enough? | B·b | paula-scher-design ch-9 |
...
| BRND-07 | taboo/stigma-adjacent category | **Need-first niche gate** — fulfill an existing need; write down who it is *not* for | Is the excluded audience named in customer-facing language? | S·b | playboy-brand-value ch-2 |
...
| BRND-13 | brand equity questioned via weak P&L | **Equity proxies** — recognition, loyalty, licensing margin, rebound speed; not only revenue | Are we measuring the asset or the quarter? | J·b | playboy-brand-value ch-11 |
| BRND-14 | designer awaits client's cultural direction | **Half-responsibility translation** — build the business case for rightness in the client's language | Can a non-designer repeat why this is right? | S·b | design-indaba-dialogues ch-5 |
