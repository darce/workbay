...
- [ ] **YAGNI / speculative-generality gate** — reject hooks/abstract layers with one (or zero) current consumers. See [engineering-heuristics.md § Refactoring & Design](engineering-heuristics.md#refactoring-design).
- [ ] **Leaky abstraction** — abstractions must not leak transport/storage detail into domain logic. See [engineering-heuristics.md](engineering-heuristics.md#refactoring-design).
