...
- [ ] **LLM trust boundaries** [SEC-01]/[SEC-04]/[SEC-05] — plans granting model agency name scopes, gates, and output mediation. See [§ Security](security-heuristics.md#1-llm-agent-security).
