...
# invoked standalone. `|| true` keeps the probe -e-safe: GNU make >= 4.0 runs
# $(shell) through SHELL/.SHELLFLAGS (root Makefile: bash -eu -o pipefail), so
# a missing pyenv would abort the snippet and expand the variable to empty.
