...
- Semantic recall / reinjection: honor install-time `embeddings_mode` and packet `semantic_degrade_reason` per [semantic-capability](../../docs/workbay/rules/semantic-capability.md); runtime `workbay embeddings` toggles do not rewrite the ledger.
