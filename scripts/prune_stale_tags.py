...
Deleting tags on the public mirror is destructive AND public, so — following
the implementation note-S2 operator-gated (``--execute``) tag-tool precedent — this
defaults to a dry-run that only prints the commands. ``--execute`` runs
