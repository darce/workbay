...
def evaluate_payload(
    ...
    *,
    ...
    # that belong to another task. This return sits AFTER the MAINT bypass,
    # the ALT_ALLOW hatch, the non-allowlisted probe_error gate, and the
    # root-worktree-on-non-main guard: those checks key on the live branch and
    # primary-worktree identity, not on the guessed task row, so an ambiguity
    # rationale must not exempt them.
